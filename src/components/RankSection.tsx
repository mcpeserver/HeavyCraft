...
export default function RankSection() {
  const ranks = [
    ...
    },
    {
      ...
      features: ["anvil", "workbench", "kits vip"],
    },
    {
      name: "MVP",
      price: "Rp 10.000 (10k)",
      ...
      features: ["anvil", "workbench", "fly", "kits mvp"],
    },
    {
      name: "ELITE",
      price: "Rp 20.000 (20k)",
      ...
      features: ["anvil", "workbench", "fly", "hat", "Nick color/format", "kits elite"],
    },
    {
      name: "HERO",
      price: "Rp 30.000 (30k)",
      ...
      features: ["anvil", "workbench", "fly", "hat", "Nick color/format/rgb", "enderchest", "kits hero"],
    },
    {
      name: "LEGEND",
      price: "Rp 50.000 (50k)",
      ...
      features: ["anvil", "workbench", "fly", "hat", "Nick color/format/rgb", "heal", "clearinven", "back", "kits legend"],
    },
    {
      name: "MYTHIC",
      price: "Rp 60.000 (60k)",
      ...
      featured: true,
      features: ["anvil", "workbench", "fly", "hat", "Nick color/format/rgb", "heal", "clearinven", "back", "itemname color/format/rgb", "kits mythic"],
    },
  ];
